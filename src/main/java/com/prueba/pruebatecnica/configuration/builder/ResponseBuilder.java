package com.prueba.pruebatecnica.configuration.builder;

import com.fasterxml.jackson.annotation.JsonFormat;

import com.prueba.pruebatecnica.configuration.TransactionState;
...
public class ResponseBuilder<T> {
    ...
    public ResponseEntity buildResponse() {
        BaseResponse base = new BaseResponse(
                this.response, this.httpStatus, this.businessStatus, this.timeResponse, this.message, this.path, this.state
        );
